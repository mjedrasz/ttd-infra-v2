...
inputs = {
  ...
  user_verification_email_subject = "Twój kod weryfikacyjny w aplikacji"
  user_verification_email_message = "Cześć,<br/><br/>Twój kod weryfikacyjny to: {####}<br/><br/>Pozdrawiamy,<br/>Zespół aplikacji"
